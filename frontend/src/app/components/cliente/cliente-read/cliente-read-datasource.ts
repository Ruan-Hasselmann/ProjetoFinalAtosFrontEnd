...
const EXAMPLE_DATA: Cliente[] = [
  {id: 1, nome: '', cpf: '', rg: '', cep: '', logradouro: '', bairro: '', localidade: '', uf: '', numeroCasa: '', dataCobranca: '', total: null, celular: '', telefone: '', pago: null, restante: null},
];
 ...
 */
export class ClienteReadDataSource extends DataSource<Cliente> {
